function [R_in,largh,AR,Kp,Cp,Jns,lon_r,lat_r,sigma_lon_r,sigma_lat_r,eps_f,V_low,kvl0,camb_0F,camb_0R,toe_0F,toe_0R,KF,Pacejka,f0_rot,K_rot,Tresh_slip]=Tyre
%%%%
% This script initializes the coefficients for Pacejka'96 tyre model
% Tyre code: 225/50 17
%%%%

% Tyre data
R_in = 17/2;               % rim radius [inch]
largh = 225;               % tyre width [mm]
AR = 50;                   % aspect ratio [-]
% Wheel mass moment of inertia [kg m^2]
Jns = 0.8;
% Tyre radial stiffness [N/m]
Kp = 2.90e5;
% Tyre radial damping [Ns/m]
Cp = 500;
% Slip threshold
Tresh_slip = 1e-2;
...
lon_r = 0.055;
lat_r = 0.5;
% Data for transient model
eps_f = 0.001;
V_low = 1.0;        % [m/s]
kvl0 = 770;         % [??]
sigma_lon_r = 0.02; % [m] (min)
sigma_lat_r = 0.10; % [m] (min)

% Toe static [deg]
toe_0F = -0.167;    % front
toe_0R = 0.196;     % rear
% Camber angle static [deg]
camb_0F = 0.0;      % front
camb_0R = -0.39;    % rear
% Compliance: F_y --> toe
KF=0;
